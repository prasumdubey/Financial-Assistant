...
from sklearn.linear_model import LogisticRegressionfrom sklearn.linear_model import LogisticRegression
from sklearn.metrics import accuracy_score, classification_report
from sklearn.model_selection import train_test_split, RandomizedSearchCVfrom sklearn.model_selection import train_test_split, RandomizedSearchCV
...
model1 = LogisticRegression()model1 = LogisticRegression()

model1.fit(X_train_scaled1, y_train1)model1.fit(X_train_scaled1, y_train1)

y_pred1 = model1.predict(X_test_scaled1)y_pred1 = model1.predict(X_test_scaled1)
...
# Define the GradientBoostingRegressor model# Define the GradientBoostingRegressor model
...
# Fit the model with the training data# Fit the model with the training data
random_search.fit(X_train2, y_train2)

# Get the best model from random search# Get the best model from random search
best_model = random_search.best_estimator_best_model = random_search.best_estimator_

# Make predictions on the test data
y_pred2 = best_model.predict(X_test2)y_pred2 = best_model.predict(X_test2)
